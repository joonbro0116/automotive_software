...
void AutonomousDriving::Run() {
    ...
    // Publish all three driveway center lines
    ...
    driveway1.frame_id = lane_points.frame_id.empty() ? "vehicle" : lane_points.frame_id;
    driveway2.frame_id = lane_points.frame_id.empty() ? "vehicle" : lane_points.frame_id;
    driveway3.frame_id = lane_points.frame_id.empty() ? "vehicle" : lane_points.frame_id;
