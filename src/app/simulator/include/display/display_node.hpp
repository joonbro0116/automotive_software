...
class Display : public rclcpp::Node {
    ...
    private:
        ...
        inline void CallbackDriveway1(const ad_msgs::msg::PolyfitLaneData::SharedPtr msg) {
            i_driveway1_ = *msg;
            b_is_driveway1_ = true;
        }
        inline void CallbackDriveway2(const ad_msgs::msg::PolyfitLaneData::SharedPtr msg) {
            i_driveway2_ = *msg;
            b_is_driveway2_ = true;
        }
        inline void CallbackDriveway3(const ad_msgs::msg::PolyfitLaneData::SharedPtr msg) {
            i_driveway3_ = *msg;
            b_is_driveway3_ = true;
        }
        ...
        void DisplayDrivingWay(const ad_msgs::msg::PolyfitLaneData& driving_way,
                               const rclcpp::Time& current_time,
                               const double& interval, const double& ROILength);
        void DisplayDrivewayWithColor(const ad_msgs::msg::PolyfitLaneData& driveway,
                                       const rclcpp::Time& current_time,
                                       const double& interval, const double& ROILength,
        ...
        rclcpp::Subscription<ad_msgs::msg::PolyfitLaneData>::SharedPtr      s_driveway1_;
        rclcpp::Subscription<ad_msgs::msg::PolyfitLaneData>::SharedPtr      s_driveway2_;
        rclcpp::Subscription<ad_msgs::msg::PolyfitLaneData>::SharedPtr      s_driveway3_;
        ...
        ad_msgs::msg::PolyfitLaneData       i_driveway1_;
        ad_msgs::msg::PolyfitLaneData       i_driveway2_;
        ad_msgs::msg::PolyfitLaneData       i_driveway3_;
        ...
        std::mutex mutex_driveway1_;
        std::mutex mutex_driveway2_;
        std::mutex mutex_driveway3_;
        ...
        rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr  p_driveway1_marker_;
        rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr  p_driveway2_marker_;
        rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr  p_driveway3_marker_;
        ...
        bool b_is_driveway1_        = false;
        bool b_is_driveway2_        = false;
        bool b_is_driveway3_        = false;
