...
static const _PolyfitLaneData_type_support_symbol_names_t _PolyfitLaneData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ad_msgs, msg, PolyfitLaneData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ad_msgs, msg, PolyfitLaneData)),
  }
};
...
{
  return &::ad_msgs::msg::rosidl_typesupport_cpp::PolyfitLaneData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ad_msgs, msg, PolyfitLaneData)() {
  return get_message_type_support_handle<ad_msgs::msg::PolyfitLaneData>();
}
