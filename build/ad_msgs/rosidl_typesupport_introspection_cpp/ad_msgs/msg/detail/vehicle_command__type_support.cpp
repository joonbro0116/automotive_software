...
{
  new (message_memory) ad_msgs::msg::VehicleCommand(_init);
}

void VehicleCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ad_msgs::msg::VehicleCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleCommand_message_member_array[3] = {
  {
    ...
    offsetof(ad_msgs::msg::VehicleCommand, steering),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ad_msgs::msg::VehicleCommand, accel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ad_msgs::msg::VehicleCommand, brake),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(ad_msgs::msg::VehicleCommand),
...
{
  return &::ad_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ad_msgs, msg, VehicleCommand)() {
  return &::ad_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleCommand_message_type_support_handle;
}
