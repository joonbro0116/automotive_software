...
bool ad_msgs__msg__lane_point_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ad_msgs.msg._lane_point_data.LanePointData", full_classname_dest, 42) == 0);
  }
  ad_msgs__msg__LanePointData * ros_message = _ros_message;
  {  // frame_id
...
{
  /* NOTE(esteve): Call constructor of LanePointData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ad_msgs.msg._lane_point_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LanePointData");
