...
bool ad_msgs__msg__mission_region__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * ad_msgs__msg__mission_region__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool ad_msgs__msg__mission_display__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ad_msgs.msg._mission_display.MissionDisplay", full_classname_dest, 43) == 0);
  }
  ad_msgs__msg__MissionDisplay * ros_message = _ros_message;
  {  // objects
  ...
  {  // regions
    ...
    if (!ad_msgs__msg__MissionRegion__Sequence__init(&(ros_message->regions), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ad_msgs__msg__MissionRegion__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ad_msgs__msg__MissionRegion * dest = ros_message->regions.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ad_msgs__msg__mission_region__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of MissionDisplay */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ad_msgs.msg._mission_display");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MissionDisplay");
  ...
  {  // regions
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ad_msgs__msg__mission_region__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
