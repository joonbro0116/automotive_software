...
class Mission(metaclass=Metaclass_Mission):
    ...
    def __eq__(self, other):
        ...
        if self.objects != other.objects:
            return False
        if self.road_condition != other.road_condition:
            return False
    ...
    @builtins.property
    def road_condition(self):
        """Message field 'road_condition'."""
        return self._road_condition

    @road_condition.setter
    def road_condition(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'road_condition' field must be of type 'str'"
        self._road_condition = value
    ...
    def road_slope(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'road_slope' field must be of type 'str'"
