...
#include "ad_msgs/msg/detail/vehicle_command__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleCommand__ros_msg_type = ad_msgs__msg__VehicleCommand;
...
static uint32_t _VehicleCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ad_msgs__msg__VehicleCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ad_msgs__msg__VehicleCommand;
    is_plain =
      (
...
static size_t _VehicleCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ad_msgs__msg__VehicleCommand(
