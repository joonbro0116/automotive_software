...
#include "ad_msgs/msg/detail/mission_display__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ad_msgs::msg::MissionRegion &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ad_msgs::msg::MissionRegion &);
size_t get_serialized_size(
  const ad_msgs::msg::MissionRegion &,
  size_t current_alignment);
size_t
max_serialized_size_MissionRegion(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const ad_msgs::msg::MissionDisplay & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ad_msgs::msg::MissionDisplay & ros_message)
{
  // Member: objects
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ad_msgs
max_serialized_size_MissionDisplay(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: regions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ad_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MissionRegion(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ad_msgs::msg::MissionDisplay;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ad_msgs::msg::MissionDisplay *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ad_msgs::msg::MissionDisplay *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MissionDisplay__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ad_msgs::msg::MissionDisplay *>(
...
static size_t _MissionDisplay__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MissionDisplay(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MissionDisplay__callbacks = {
  "ad_msgs::msg",
  "MissionDisplay",
...
static rosidl_message_type_support_t _MissionDisplay__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MissionDisplay__callbacks,
...
{
  return &ad_msgs::msg::typesupport_fastrtps_cpp::_MissionDisplay__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ad_msgs, msg, MissionDisplay)() {
  return &ad_msgs::msg::typesupport_fastrtps_cpp::_MissionDisplay__handle;
}
